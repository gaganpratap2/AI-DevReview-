...
export default function ReviewsPage() {
  ...
  // Your current tRPC type does not expose the review router,
  // so keep this cast until the router registration is fixed.
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <RefreshCw
            className={cn(
              "size-4",
              reviews.isFetching && "animate-spin",
            )}
          />
        </Button>
      </div>
