...
export default function RepositoryDetailPage({ params }: PageProps) {
  ...
  // Fetch the full set once so tab counts stay accurate no matter which
  // tab is active, and derive the filtered list from it client-side.
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="flex items-center gap-4 text-sm">
                <code className="px-2 py-0.5 rounded-md bg-muted text-xs font-mono text-muted-foreground flex items-center truncate">
                  {pr.baseRef}
                  <ArrowLeft className="mx-1.5 size-3 text-muted-foreground/50 shrink-0" />
                  {pr.headRef}
                </code>
                <div className="flex items-center gap-3">
